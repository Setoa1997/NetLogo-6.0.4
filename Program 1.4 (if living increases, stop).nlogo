globals [ number-of-actual-living ] ;number of living cells
                        ;program remembers how many cells (magenta) live in a generation
                        ;program compares whether the new generation has more living cells
                        ;if the next generation has more living cells => stop
...
to setup-blank
  ...
  set number-of-actual-living count patches with [ living? ]
  reset-ticks
end
...
to go
  ;if number of living cells increased => stop
  ask patches
  ...
  ask patches
    [ ifelse live-neighbors = 3
      ...
      [ if live-neighbors != 2
        [ cell-death ] ] ]
  if count patches with [ living? ] > number-of-actual-living [ stop ]
  set number-of-actual-living count patches with [ living? ]
  tick
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count patches with [pcolor = fgcolor]"
